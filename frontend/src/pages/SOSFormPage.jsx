...
const SOSFormPage = () => {
  ...
  const [notificationMessage, setNotificationMessage] = useState(''); // Add this line
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setNotificationMessage('SOS report submitted successfully'); // Set the message
      setIsNotificationModalOpen(true); // Open the modal
      setRespondentName('');
      setPhoneNumber('');
      setEmergencyType('');
      setAffectedPeople('');
      ...
      setNotificationMessage('Error reporting SOS'); // Set the error message
      setIsNotificationModalOpen(true); // Open the modal
    }
  };
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3 d-flex">
            <select
              ...
              required
            >
              <option value="" disabled>Select type of emergency</option>
            ...
            <select
              ...
              required
            >
              <option value="" disabled>Apx. number of people affected</option>
          ...
          <button type="submit" className="btn btn-success">Notify</button>
          </div>
        </form>
      </div>
