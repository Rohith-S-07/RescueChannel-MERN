...
const UserManagement = () => {
  ...
  useEffect(() => {
    axios.get(`${config.BASE_URL}/api/admin/users`, { withCredentials: true })
      .then(response => {
  ...
  const confirmStatusChange = () => {
    ...
    axios.put(`${config.BASE_URL}/api/admin/users/${id}/status`, { status: newStatus }, { withCredentials: true })
      .then(response => {
  ...
  const confirmDeletion = () => {
    ...
    axios.delete(`${config.BASE_URL}/api/admin/users/${id}`, { withCredentials: true })
      .then(response => {
              ...
              <tr key={user._id}>
                ...
                <td>
                  {user.licenseDocument && (
                    <a
                      href={`${config.BASE_URL}/${user.licenseDocument}`}
                      target="_blank"
